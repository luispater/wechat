...
import (
	...
	"github.com/luispater/wechat/v2/cache"
	"github.com/luispater/wechat/v2/context"
	"github.com/luispater/wechat/v2/device"
	"github.com/luispater/wechat/v2/js"
	"github.com/luispater/wechat/v2/material"
	"github.com/luispater/wechat/v2/menu"
	"github.com/luispater/wechat/v2/message"
	"github.com/luispater/wechat/v2/miniprogram"
	"github.com/luispater/wechat/v2/oauth"
	"github.com/luispater/wechat/v2/pay"
	"github.com/luispater/wechat/v2/qr"
	"github.com/luispater/wechat/v2/server"
	"github.com/luispater/wechat/v2/tcb"
	"github.com/luispater/wechat/v2/user"
)
...
func copyConfigToContext(cfg *Config, context *context.Context) {
	...
	context.Socks5ProxyAddr = cfg.Socks5ProxyAddr
	context.Socks5ProxyUser = cfg.Socks5ProxyUser
	context.Socks5ProxyPswd = cfg.Socks5ProxyPswd
