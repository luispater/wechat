...
func HTTPGetSocks5(uri, socks5addr, socks5user, socks5password string) ([]byte, error) {
	var client *http.Client
	if socks5addr != "" {
		dialer, _ := proxy.SOCKS5("tcp", socks5addr,
			&proxy.Auth{User: socks5user, Password: socks5password},
			&net.Dialer{
